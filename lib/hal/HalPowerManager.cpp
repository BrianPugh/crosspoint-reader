...
// X4 Pro display chip select. (Flash SPIWP pad, unused in this board's DIO
// flash mode: high keeps the battery connected, low powers the device off.)
...
void HalPowerManager::startDeepSleep(HalGPIO& gpio) const {
  ...
  if (gpio.isXteinkDevice()) {
    ...
    // and a held pad silently ignores the drive.
